...
AWiTracingSimCharacter::AWiTracingSimCharacter()
{
...
void AWiTracingSimCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void AWiTracingSimCharacter::MoveRight(float Value)
{
	if ( (Controller != nullptr) && (Value != 0.0f) )
	{
