...
Fusion model v4. Input with 3 LSTM feature extractor and a dot product attention as the fusing layer.
...
class FusionModelv4(nn.Module):
    def __init__(self, wifi_feature_size, imu_feature_size, visual_feature_size, lstm_hidden_size,
        ...
        super(FusionModelv4, self).__init__()
        # Wifi encoder
    ...
    def forward(self, obs):
        ...
        out_feature = self.attention(combined_features, visual_features, visual_features)
